...
Item {
    ...
    implicitHeight: (content.children.find(c => c.shouldBeActive)?.implicitHeight ?? 0) + Appearance.padding.large + Appearance.padding.larger * 2.5
    ...
    Item {
        ...
        anchors.bottomMargin: Appearance.padding.larger * 2.5
